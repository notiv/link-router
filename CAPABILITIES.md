...
| `macos-shell` | Receive web and local-file URLs, launch Safari or a normal/private Chrome profile, and register as the default browser and HTML viewer | `routing-core` |
